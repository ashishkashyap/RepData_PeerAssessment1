...
for(i in 1:nrow(x=activityDataWithNAFilled)){
    if(activityDataWithNAFilled$dayOfTheWeek == "Saturday" | activityDataWithNAFilled$dayOfTheWeek == "Sunday"){
        activityDataWithNAFilled$dayOfTheWeek <- "Weekend"
    }else{
        activityDataWithNAFilled$dayOfTheWeek <- "Weekday"
    }
}
